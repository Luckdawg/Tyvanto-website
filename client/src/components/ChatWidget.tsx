...
export default function ChatWidget() {
  ...
  const quickReplies: QuickReply[] = [
    ...
    { text: "Pricing information", response: "Tyvanto offers transparent, hybrid pricing — a predictable base fee plus metered usage. Entry points range from $1,299/mo (Arqen Command AI Governance) to $19,950/mo (Arqen Grid). Arqen starts at $7,995/mo, Arqen Vision at $7,499/mo, and ELI at $9,499/mo. Annual billing saves 10% across all products. Visit our Shop page for the full comparison table and interactive pricing calculator, or speak with our sales team for a custom quote." },
    { text: "Key features", response: "Arqen's key features include: (1) Dual Database Architecture with graph database + relational database, (2) Agentic AI with autonomous workflow execution, (3) Real-time threat detection with 75% faster MTTD, (4) Arqen Vision™ Video Intelligence, (5) an independent research organization ATT&CK framework integration, (6) Digital twin capabilities, and (7) Defense-grade provenance. Which feature would you like to learn more about?" },
  ...
  const knowledgeBase: { [key: string]: string } = {
    ...
    "video intelligence": "Arqen Vision™ is our autonomous video intelligence platform that provides real-time face recognition, license plate detection (ALPR), behavioral analytics, and multi-camera event correlation. It can analyze 1,200+ video streams simultaneously with autonomous investigation planning.",
    "tru-insight": "Arqen Vision™ is our autonomous video intelligence platform that provides real-time face recognition, license plate detection (ALPR), behavioral analytics, and multi-camera event correlation. It can analyze 1,200+ video streams simultaneously with autonomous investigation planning.",
    ...
    "pricing": "Tyvanto uses hybrid pricing — a predictable base fee plus transparent metered usage. Our product lineup: Arqen Command AI Governance from $1,299/mo (flat tier + agent count), Arqen Command from $3,499/mo (flat rate), Arqen Trace from $3,499/mo (flat rate), Arqen Vision from $3,995/mo (flat rate), Arqen Grid from $4,750/mo (flat rate), Arqen Vision Video Intelligence from $7,499/mo (base + $2.00/camera), Arqen from $7,995/mo (base + tiered node rate), Arqen Sentinel from $9,499/mo (base + $4/node overage), and Arqen Grid from $19,950/mo (usage-based). Annual billing saves 10% on all products. Visit our Shop page for the interactive pricing calculator and full comparison table.",
