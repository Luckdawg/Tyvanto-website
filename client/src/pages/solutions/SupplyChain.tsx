...
export default function SupplyChain() {
  return (
    <div className="min-h-screen">
      <SEOHead 
        title="Supply Chain Logistics & Visibility Platform | Tyvanto"
        ...
        canonicalUrl="https://www.tyvanto.com/solutions/supply-chain"
      />
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Arqen provides the intelligence and insights needed to optimize operations, enhance security, and ensure compliance in supply chain & logistics.
            </p>
          </div>
